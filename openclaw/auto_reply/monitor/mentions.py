...
class MentionMatch:
    ...
    agent_id: Optional[str] = None  # Detected agent ID
    is_mention: bool = False  # Whether this is a valid mention


def detect_mentions(text: str, agent_names: Optional[list[str]] = None) -> list[MentionMatch]:
...
def has_mention(text: str, agent_names: Optional[list[str]] = None) -> bool:
