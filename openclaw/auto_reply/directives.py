...
class ExtractedDirective:
    ...
    raw_level: Optional[str] = None  # Raw level string if provided
...
def normalize_think_level(raw: Optional[str]) -> Optional[str]:
...
def normalize_verbose_level(raw: Optional[str]) -> Optional[str]:
...
def normalize_reasoning_level(raw: Optional[str]) -> Optional[str]:
...
def normalize_notice_level(raw: Optional[str]) -> Optional[str]:
...
def extract_think_directive(body: Optional[str]) -> ThinkDirectiveResult:
    ...
    result = extract_level_directive(
        body,
        ["thinking", "think", "t"],
...
def extract_verbose_directive(body: Optional[str]) -> VerboseDirectiveResult:
...
def extract_elevated_directive(body: Optional[str]) -> ElevatedDirectiveResult:
...
def extract_reasoning_directive(body: Optional[str]) -> ReasoningDirectiveResult:
...
def extract_notice_directive(body: Optional[str]) -> NoticeDirectiveResult:
...
def extract_status_directive(body: Optional[str]) -> ExtractedDirective:
