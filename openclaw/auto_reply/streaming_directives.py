...
def parse_chunk(raw: str, silent_token: str = SILENT_REPLY_TOKEN) -> dict:
    ...
    reply_parsed = parse_inline_directives(
        text,
        strip_audio_tag=False,
...
class StreamingDirectiveAccumulator:
    ...
    def consume(
        ...
        raw: str,
        final: bool = False,
        silent_token: str = SILENT_REPLY_TOKEN
    ) -> Optional[ReplyDirectiveParseResult]:
